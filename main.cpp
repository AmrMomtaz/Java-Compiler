#include "lexical_analyzer_generator/NFA.h"
#include "lexical_analyzer_generator/LexicalAnalyzer.h"
...
std::string tokenize(string s, const string removed_chars, const string c) {
