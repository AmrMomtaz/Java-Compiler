...
//    first={make_pair("int",vector<string>{"PRIMITIVE_TYPE"}),make_pair("float",vector<string>{"PRIMITIVE_TYPE"})};
//    follow={"int","float","if","while","id","$"};
...
//    first={make_pair("if",vector<string>{"if"})};
//    follow={"int","float","if","while","id","$"};
//    LL1["IF"] = make_pair(first,follow);
//    first={make_pair("while",vector<string>{"while"})};
//    follow={"int","float","if","while","id","$"};
//    LL1["WHILE"] = make_pair(first,follow);
//    first={make_pair("id",vector<string>{"id","=","EXPRESSION",";"})};
//    follow={"int","float","if","while","id","$"};
